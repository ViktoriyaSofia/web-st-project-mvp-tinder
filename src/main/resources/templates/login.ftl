...
<div class="cover-container d-flex w-100 h-100 p-3 mx-auto flex-column">
    ...
    <main class="px-3">
    <form class="form-signin" action="/profiles" method="post">
        ...
        <h1 class="h3 mb-3 font-weight-normal" style="margin-top: 1.5rem; margin-bottom: 1.5rem; color: #428dff;">Please sign in</h1>

        <label for="inputLogin" class="sr-only">Login</label>
        <input type="text" id="inputLogin" name="login" class="form-control" placeholder="Enter Login" required autofocus>

        <label for="inputPassword" class="sr-only">Password</label>
        <input type="password" id="inputPassword" name="password" class="form-control" placeholder="Enter Password" required autofocus> <br>

        <button type="submit" class="btn btn-lg btn-secondary fw-bold border-white bg-white">Sign in</button>
    </form>
